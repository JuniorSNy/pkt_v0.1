...
HD_PWD='C:/Users/shiji/Documents/pkt_scheduler/pkt_scheduler.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pkt_sche_v0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pkt_sche_v0_1.tcl
